...
<link href="<%=request.getContextPath()%>/resources/css/header.css"
	rel="stylesheet" type="text/css">
<link href="<%=request.getContextPath()%>/resources/css/productEdit.css"
	rel="stylesheet" type="text/css">
		...
		<form method="post" enctype="multipart/form-data" id="edfrm">
			<section id="content_enroll">
				...
				<div id="product_enroll_grp">
					...
					<div class="enroll_content">
						<label for="prod_brand" style="font-size: 15px;">브랜드명을 입력해주세요. </label><br> 							<input type="text" name="prod_brand" id="prod_brand" 	placeholder="브랜드명을 입력해주세요.">
					</div>
					<div class="enroll_content">
						<!-- 상품 이름 -->
					...
					<div class="enroll_content">
						<!-- 옵션 추가가격 -->
						<label for="opt_price" style="font-size: 15px">옵션 가격을 입력해주세요.</label><br> 
